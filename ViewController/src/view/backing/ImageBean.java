...
public class ImageBean {
    ...
    public void uploadFileValueChangeEvent(ValueChangeEvent valueChangeEvent) {
        ...
        DCIteratorBinding lBinding = lBindingContainer.findIteratorBinding("Files1Iterator");
        ...
        newRow.setAttribute("UploadedFile", blob.getDataBlob());
        // set the mime type
        ...
        ui = ui.getParent();
        System.out.println("KKKKKKKKKKKKKKKKKKKKKKKKKKKK Refreshing the PAGE");
